public class polymorphism {
    public static void main(String[] args) {
        ...
        // The output will be clucking from Henrietta, mooing from Bessie, and baaing from Shaun, with each producing eggs, milk, and wool respectively.
    }
}
